...
function branco() {
        ...
        aviso.style.display = 'block';
        numeros.innerHTML = '';
        descricao.innerHTML = '<div class="aviso-vt-branco pisca">VOTO EM: <span class="onlybranco">BRANCO</span></div>';
        lateral.innerHTML = '';
...
function confirma() {
   ...
   if(votoConfirmado) {
       ...
       if(etapas[etapaAtual] !== undefined) {
           ...
           document.querySelector('.tela').innerHTML = '<div class="aviso-gigantesco pisca">FIM</div>';
       }
   }
}
